...
public class MainActivity extends AppCompatActivity {
    ...
    TextView errorMesseageTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorMesseageTextView = (TextView) findViewById(R.id.tv_error_messeage);
    ...
    public void showJsonDataView(){
        errorMesseageTextView.setVisibility(View.INVISIBLE);
    ...
    public void showErrorMesseage(){
        errorMesseageTextView.setVisibility(View.VISIBLE);
